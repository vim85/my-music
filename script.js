...
function buildArtists() {
    ...
    ARTISTS.forEach(artist => {
        ...
        div.onclick = () => { 
            searchInput.value = `${artist} songs`; 
            searchSongs(`${artist} songs`); 
        };
...
async function searchSongs(query) {
    exploreSection.style.display = 'none'; // Hide explore section on search
...
function fetchTrendingSongs() {
    ...
    searchInput.value = '';
    exploreSection.style.display = 'block'; // Show explore section
...
function showFavorites() {
    exploreSection.style.display = 'none'; // Hide explore section
